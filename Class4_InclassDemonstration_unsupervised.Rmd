...
Ensure that all packages are installed. Note that the package ggbiplot is not available in R. We are downloading it from the developer's github repository.
